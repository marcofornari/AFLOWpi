...
session = AFLOWpi.prep.init('AFLOWPI_EXAMPLES', 'HALL',config='./Hall.config')
...
calcs_tb=calcs.tight_binding(proj_thr=0.95,tb_kp_factor=4,symmetrize=False)
...
calcs_tb=calcs.tight_binding(proj_thr=0.95,tb_kp_factor=4,symmetrize=True,sym_thr=1.e-8,sym_max_iter=50)
