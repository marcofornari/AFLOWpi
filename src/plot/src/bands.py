...
def __bands(oneCalc,ID,yLim=[-10,10],DOSPlot='',postfix='',tight_banding=False,SBC=False):
	'''
	...
	if SBC==True:
		__bandPlot(oneCalc,yLim,DOSPlot,postfix=postfix,tight_banding=tight_banding,SBC=SBC)
	...
	if not SOC:
		...
		__bandPlot(oneCalc,yLim,DOSPlot,postfix=postfix,tight_banding=tight_banding,spin_dir='X')
		__bandPlot(oneCalc,yLim,DOSPlot,postfix=postfix,tight_banding=tight_banding,spin_dir='Y')
		__bandPlot(oneCalc,yLim,DOSPlot,postfix=postfix,tight_banding=tight_banding,spin_dir='Z')
...
def __bandPlot(oneCalc,yLim=[-10,10],DOSPlot='',postfix='',tight_banding=False,spin_dir='',SBC=False): 
	'''
